...
def printMinInitApproval(companiesList):
    ...
    # fiscalYear = companiesList["fiscalYear"]
...
def printCompany(companyList):
    """Print statistics of a company

    Arguments:
    companyList -- list of companies (list)
    """
...
def readFile(filePath):
    ...
    with open(filePath, 'r') as file:
        ...
        for line in reader:
            ...
            if int(fiscalYear) < int(fiscalYear):
